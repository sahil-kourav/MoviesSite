                  ...
                  <div className="mt-8 space-y-4">
                    {movie.homepage && (
                      <a
                        ...
                        className="inline-flex items-center gap-2 bg-neutral-700 hover:bg-neutral-600 text-white px-4 py-2 rounded transition-colors"
                      >
                        <Globe size={20} />
                        Official Website
                      </a>
                    ...
                    {movie.imdb_id && (
                      ...
                      >
                        ...
                        >
                          <path
                            d="M22 2H2V22H22V2ZM4 4H20V20H4V4ZM9.5 8H7V16H9.5V14H8V10H9.5V8ZM14.5 10H13V16H11V8H13V10H14.5V8H16V16H14.5V10ZM19 14H17V16H19V14ZM17 8V12H19V8H17Z"
                            fillRule="evenodd"
                            clipRule="evenodd"
                          />
                        </svg>
